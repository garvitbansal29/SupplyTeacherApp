...
public class SchoolRegisterDetail extends AppCompatActivity {
    ...
    EditText schoolName_field, postcode_field, addressLine1_field, addressLine2_field, town_field, county_field, phone_field, yearsOfExperience_field, subjects_field;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        schoolName_field = findViewById(R.id.name_field);
    ...
    public void registerSchoolDetailsOnClick(View view)
    {
        ...
        schoolName = schoolName_field.getText().toString();
